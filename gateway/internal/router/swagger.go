//see: https://github.com/swaggo/http-swagger
...
// HandlerSwagger wraps `http.Handler` into `runtime.HandlerFunc`.
func HandlerSwagger(configFns ...func(*Config)) runtime.HandlerFunc {
	...
	return func(w http.ResponseWriter, r *http.Request, pathParams map[string]string) {
		...
		case "market.json":
			doc, err := os.ReadFile("docs/market/market.swagger.json")
			if err != nil {
