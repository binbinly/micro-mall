...
const (
	...
	Member_Edit_FullMethodName           = "/member.Member/Edit"
	Member_PwdEdit_FullMethodName        = "/member.Member/PwdEdit"
	Member_Profile_FullMethodName        = "/member.Member/Profile"
...
type MemberClient interface {
	...
	// / 修改会员信息
	Edit(ctx context.Context, in *EditReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// / 修改密码
	PwdEdit(ctx context.Context, in *PwdEditReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// / 获取会员信息
	Profile(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*MemberReply, error)
	// / 登出
...
func (c *memberClient) Edit(ctx context.Context, in *EditReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Member_Edit_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) PwdEdit(ctx context.Context, in *PwdEditReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Member_PwdEdit_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) Profile(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*MemberReply, error) {
	out := new(MemberReply)
	err := c.cc.Invoke(ctx, Member_Profile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MemberServer interface {
	...
	// / 修改密码
	PwdEdit(context.Context, *PwdEditReq) (*emptypb.Empty, error)
	// / 获取会员信息
	Profile(context.Context, *emptypb.Empty) (*MemberReply, error)
	// / 登出
...
func (UnimplementedMemberServer) Edit(context.Context, *EditReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Edit not implemented")
}
func (UnimplementedMemberServer) PwdEdit(context.Context, *PwdEditReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PwdEdit not implemented")
}
func (UnimplementedMemberServer) Profile(context.Context, *emptypb.Empty) (*MemberReply, error) {
...
func _Member_Edit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EditReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemberServer).Edit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Member_Edit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemberServer).Edit(ctx, req.(*EditReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Member_PwdEdit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PwdEditReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemberServer).PwdEdit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Member_PwdEdit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemberServer).PwdEdit(ctx, req.(*PwdEditReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Member_Profile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemberServer).Profile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Member_Profile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemberServer).Profile(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Member_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Edit",
			Handler:    _Member_Edit_Handler,
		},
		{
			MethodName: "PwdEdit",
			Handler:    _Member_PwdEdit_Handler,
		},
		{
			MethodName: "Profile",
			Handler:    _Member_Profile_Handler,
		},
		{
			MethodName: "Logout",
