...
const (
	...
	Cart_BatchDelCart_FullMethodName = "/cart.Cart/BatchDelCart"
...
type CartClient interface {
	...
	// / 批量删除购物车
	BatchDelCart(ctx context.Context, in *common.SkuIDReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// / 清空购物车
...
func (c *cartClient) BatchDelCart(ctx context.Context, in *common.SkuIDReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Cart_BatchDelCart_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CartServer interface {
	...
	// / 批量删除购物车
	BatchDelCart(context.Context, *common.SkuIDReq) (*emptypb.Empty, error)
	// / 清空购物车
...
func (UnimplementedCartServer) BatchDelCart(context.Context, *common.SkuIDReq) (*emptypb.Empty, error) {
...
func _Cart_BatchDelCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cart_BatchDelCart_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServer).BatchDelCart(ctx, req.(*common.SkuIDReq))
	}
	return interceptor(ctx, in, info, handler)
}
